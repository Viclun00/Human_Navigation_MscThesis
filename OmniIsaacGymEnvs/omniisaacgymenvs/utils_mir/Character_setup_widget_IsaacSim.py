...
class CharacterSetupWidget:
    ...
    def __init__(self):
        ...
        self.default_biped_asset_name = "biped_demo_meters"
    ...
    def _load_characters_on_clicked(self, cmd_file_path):
    ...
    def _init_characters(self, cmd_lines):
        ...
        if people_asset_folder:
            ...
            if root_path is None:
                ...
                return
            self.assets_root_path  = "/{}".format(root_path)
